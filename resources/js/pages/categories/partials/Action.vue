...
const toggleStatus = () => router.put(`/categories/${props.item.id}/toggle-status`);
const confirmDelete = () => {
  ...
  <Teleport to="body">
    ...
    >
      ...
      <button
        ...
        :class="item.is_active ? 'text-yellow-600' : 'text-green-600'"
      >
        <component :is="item.is_active ? XCircle : CheckCircle" class="h-4 w-4" />
