...
onMounted(() => {
  if (props.product.data.product_photo) {
    profilePreview.value = props.product.data.product_photo.url
  }
})
...
const form = useForm<ProductForm>({
    barcode: props.product.data.barcode || '',
    name: props.product.data.name || '',
    category_id: props.product.data.category_id || props.product.data.category?.id || null,
    cost_price: props.product.data.cost_price,
    selling_price: props.product.data.selling_price,
    reorder_level: props.product.data.reorder_level,
    product_photo: props.product.data.product_photo ? null : null,
});
...
const submit = () => {
    ...
    .put(`/products/${props.product.data.id}`, {
        onSuccess: () => {
