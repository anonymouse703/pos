...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/suppliers/${props.supplier.data.id}/edit` },
];
...
const form = useForm<SupplierForm>({
    ...
    contact_person: props.supplier.data.contact_person || '',
    phone: props.supplier.data.phone || '',
    email: props.supplier.data.email || '',
    address: props.supplier.data.address || '',
    terms_days: props.supplier.data.terms_days || '',
    opening_balance: props.supplier.data.opening_balance || 0,
});
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm w-full max-w-5xl mx-auto">
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input v-model="form.name" type="text" id="name" placeholder="Supplier Name"
                    ...
                    <div class="space-y-2">
                        ...
                        <p v-if="form.errors.contact_person" class="text-red-600 text-sm">{{ form.errors.contact_person
                            }}</p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <Input v-model="form.phone" type="text" id="phone" placeholder="Phone"
                            class="w-full bg-white dark:bg-gray-200 text-gray-900 dark:text-gray-500 border-gray-300 dark:border-gray-600"
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea v-model="form.address" id="address" rows="4"
                            ...
                            placeholder="Brief address of this supplier..."></textarea>
                    ...
                    <div class="flex gap-6">
                        ...
                        <div class="space-y-2 w-1/2">
                            ...
                            <Input v-model="form.terms_days" type="number" id="terms_days" placeholder="Terms in days"
                                class="w-full bg-white dark:bg-gray-200 text-gray-900 dark:text-gray-500 border-gray-300 dark:border-gray-600"
                                :class="{ 'border-red-500': form.errors.terms_days }" />
                            <p v-if="form.errors.terms_days" class="text-red-600 text-sm">{{ form.errors.terms_days }}
                            </p>
                        </div>

                        <!-- Opening Balance -->
                        <div class="space-y-2 w-1/2">
                            <Label for="opening_balance" class="text-sm font-medium text-gray-900">Opening
                                Balance</Label>
                            <input ref="openingBalanceRef" v-model="form.opening_balance" type="text"
                                placeholder="₱ 0.00"
                            ...
                            <p v-if="form.errors.opening_balance" class="text-red-600 text-sm">{{
                                form.errors.opening_balance }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex gap-3">
                            ...
                            <Button type="submit" :disabled="form.processing"
                                ...
                                <span>{{ form.processing ? 'Updating...' : 'Update Supplier' }}</span>
                            </Button>
                        </div>
                    </div>
                </form>
